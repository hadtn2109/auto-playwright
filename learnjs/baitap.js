...
console.log(userName("Admin")); //Welcome admin
console.log(userName("ADMIN")); //Welcome admin
console.log(userName("adMin")); //Welcome admin
console.log(userName("Ngocha")); //welcome ngocha
console.log(userName("123A@")); //welcome 123a@
...
console.log("Mã sản phẩm là", idProduct("abcde")); //Mã sản phẩm là ABCDE
console.log("Mã sản phẩm là", idProduct("Abc123")); //Mã sản phẩm là ABC123
console.log("Mã sản phẩm là", idProduct("@abc123")); //Mã sản phẩm là @ABC123
...
console.log(sanitizeSearchString("     Ngocha    ")); //Ngocha
console.log(sanitizeSearchString("     123456    ")); //123456
console.log(sanitizeSearchString("     ABC@@@    ")); //ABC@@@
...
console.log(listStudents(Students)); //[ 'Anh', 'An' ]
...
//   Kiến thức sử dụng: filter()
let a = [-2, -0.5, 1, 0, 3.14, 2 / 3, 50, 99];
let b = a.filter(function (num) {
  //num: thể hiện cho từng phần tử trong mảng
  return Number.isInteger(num); //Number: k là biến thông thường. là đối tượng có sẵn, cho phép sử dụng trực tiếp
});
console.log(b);
...
// split(): sử dụng trên đối tượng là String, sùng để chia chuỗi thành mảng các chuỗi con, dựa trên dấu xác định
...
console.log(xuLyThongBao("System Error"));
console.log(xuLyThongBao("502 Bad Gateway"));
